...
<body>
    <div class="nabar">
        ...
        <div class="header">
            <div class="logo">
                <p style="color: tomato;">G</p>RIP BANK
            </div>
            <div class="menu">
                <ul>
                    <li><a class="lin" href="index.php">Home</a></li>
                    <li style="background-color: rgb(85,166, 48);"><a class="lin" href="transaction.php">Transaction History</a></li>
